...
gym.register(
    id="Isaac-Jump-Solo-v0",
    entry_point="omni.isaac.orbit.envs:RLPlanningTaskEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": jump_platform_env_cfg.SoloJumpEnvCfg,
...
gym.register(
    id="Isaac-Jump-Solo-Play-v0",
    entry_point="omni.isaac.orbit.envs:RLPlanningTaskEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": jump_platform_env_cfg.SoloJumpEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_cfg.SoloPPORunnerCfg,
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_td3_cfg.yaml",
    },
)
