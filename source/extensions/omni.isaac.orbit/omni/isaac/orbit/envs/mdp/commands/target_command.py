...
if TYPE_CHECKING:
    ...
    from .commands_cfg import UniformTargetCommandCfg


class UniformTargetCommand(CommandTerm):
    ...
    cfg: UniformTargetCommandCfg
    """Configuration for the command generator."""

    def __init__(self, cfg: UniformTargetCommandCfg, env: BaseEnv):
        ...
        print(self.robot.data.root_pos_w)
