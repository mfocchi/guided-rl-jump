...
UNITREE_ALIENGO_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/riccardo/Documents/orbit/source/extensions/omni.isaac.orbit_assets/data/Robots/Unitree/aliengo.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        ...
        "base_legs_calf": DCMotorCfg(
            joint_names_expr=[".*_calf_joint"],
            effort_limit=44.4,  # taken from spec sheet
